...
PARAM$input$dataset <- "./datasets/exp_1.csv.gz"
...
PARAM$hyperparametertuning$semilla_azar <- 100079
#------------------------------------------------------------------------------
...
setwd("/home/mbujandmeyf/buckets/b1/datasets") # Establezco el Working Directory
